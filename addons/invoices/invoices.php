<?php
/**
 * Based on "Camptix Invoices" (https://wordpress.org/plugins/invoices-camptix/) by Willy Bahuaud & Simon Janin
...
class CampTix_Addon_Invoices extends \CampTix_Addon {
	...
	static function enqueue_assets() {
		wp_register_script( 'invoices-camptix', plugins_url( 'addons/invoices/camptix-invoices.js', __FILE__ ), array( 'jquery' ), CTX_INV_VER, true );
		...
		wp_register_style( 'camptix-invoices-css', plugins_url( 'addons/invoices/camptix-invoices.css', __FILE__ ), array(), CTX_INV_VER );
	...
	static function admin_enqueue_assets() {
		wp_register_script( 'admin-camptix-invoices', plugins_url( 'addons/invoices/camptix-invoices-back.js', __FILE__ ), array( 'jquery' ), CTX_INV_VER, true );
	}
